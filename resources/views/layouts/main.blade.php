...
<head>
    ...
    <link href="{{ asset('assets/vendor/owlcarousel/css/owl.carousel.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/owlcarousel/css/owl.theme.default.min.css') }}" rel="stylesheet">
